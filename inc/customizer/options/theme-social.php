<?php
	...
	$wp_customize->add_control( 'theme_social_target', array(
		...
		'label'   => esc_html__( 'Open social and sharing links in a new tab.', 'vidiho-pro' ),
	) );
	...
	foreach ( $networks as $network ) {
		...
		$wp_customize->add_control( $social_mod, array(
			...
			'label'   => esc_html( sprintf( _x( '%s URL', 'social network url', 'vidiho-pro' ), $network['label'] ) ),
		) );
	}
