<?php
	...
	$wp_customize->selective_refresh->add_partial( 'theme_blogname', array(
		...
		'render_callback' => 'vidiho_pro_customize_preview_blogname',
	) );

	$wp_customize->get_setting( 'blogdescription' )->transport = 'postMessage';
	$wp_customize->selective_refresh->add_partial( 'theme_blogdescription', array(
		'selector'        => '.site-tagline',
		'render_callback' => 'vidiho_pro_customize_preview_blogdescription',
	) );
	...
	$wp_customize->add_control( 'limit_logo_size', array(
		...
		'priority'    => 8,
		'label'       => esc_html__( 'Limit logo size (for Retina display)', 'vidiho-pro' ),
		'description' => esc_html__( 'This option will limit the image size to half its width. You will need to upload your image in 2x the dimension you want to display it in.', 'vidiho-pro' ),
	) );
	...
	$wp_customize->add_control( 'show_site_title', array(
		'type'    => 'checkbox',
		'section' => 'title_tagline',
		'label'   => esc_html__( 'Show site title', 'vidiho-pro' ),
	) );
	...
	$wp_customize->add_control( 'show_site_description', array(
		'type'    => 'checkbox',
		'section' => 'title_tagline',
		'label'   => esc_html__( 'Show site tagline', 'vidiho-pro' ),
	) );

	$wp_customize->selective_refresh->add_partial( 'theme_site_branding', array(
		'selector'            => '.site-branding',
		'render_callback'     => 'vidiho_pro_the_site_identity',
